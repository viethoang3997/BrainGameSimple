let questions=[{
  question: 'What is 2 + 8 ?', choice: [ '2', '4', '21', '10'], answer: 10
},
    
{
  question: 'What is 4 * 3 ?', choice: [ '2', '7', '12', '19'], answer: 12
},
    
{
  question: 'What is 9 / 3 ?', choice: [ '2', '3', '21', '17'], answer: 3
},
    
{
  question: 'What is 12 - 8 ?', choice: [ '2', '4', '21', '17'], answer: 4
}]
  ...
  function renderQuestion(index=0) {
    document.getElementById('question').innerHTML = 'Question: ' + questions[index]['question'] ;
    let answer='';
